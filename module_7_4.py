...
print("Команда Волшебники данных решаила задач: {team_result} !".format(team_result=score_2))
print("Волшебники данных решили задачи за {team_time} с !".format(team_time=team2_time))
